...
const Videop = () => {
  ...
  useEffect(() => {
    console.log("acc");
    fetch(
      `https://api.themoviedb.org/3/movie/${userId}/videos?api_key=6ff4c3806365f19269082c91227e14bc`
    )
  ...
  return (
    <>
      <h2 className="color_red">Title: {(remainingItems[0].title)  ? remainingItems[0].title : remainingItems[0].name }</h2>
